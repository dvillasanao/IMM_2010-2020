   ...
   tab_options(heading.title.font.size = 12, 
    ...
    tab_style(style = list(cell_text(align = "center",
     ...
     cols_label(`desvest` = md("**Desviación estándar**"), 
      ...
      fmt_number(columns = c(1:3), decimals = 3) %>%
      as_raw_html()
```
...
DP2_2020 %>% 
 rename("AÑO" = "ANIO") %>%
  slice(1:25) %>%
  gt() %>%
   tab_header(title = "Índice de marginación a nivel municipal, 2020") %>%
    tab_options(heading.title.font.size = 12, 
                heading.align = "center",
                heading.subtitle.font.size = 10,
                table.align = "center",
     ...
     tab_style(style = list(cell_text(align = "center",
      ...
      fmt_integer(columns = "POB_TOT", sep_mark = " ") %>%
       fmt_number(columns = c(7:15), decimals = 1) %>%
        fmt_number(columns = c(16, 18), decimals = 3) %>%
